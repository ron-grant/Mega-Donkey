/*  md_DemoLCD.c
    ...
    Mega Donkey LCD Graphics Demo
	Mark Sims  January-March 2007
    

	Demos Many of Donkeys LCD Graphics Features
	...
	Note that Analog Clock can be found by itself in md_AnalogClock with a minor 
	addition that allows the clock to be scaled.
